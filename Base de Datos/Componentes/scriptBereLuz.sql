...
BEGIN
Alter table Cita_Servicio add constraint fk_CitaServNumCita foreign key (numCita,dia) references Cita(numCita,dia) 
END
...
BEGIN
Alter table Factura add constraint fk_FactUsuario foreign key (cliente) references aspnet_Users(UserId) 
END
